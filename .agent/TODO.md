...
- [ ] Implement render loop: acquire/present, record per-frame commands to clear + draw white triangle, handle VK_ERROR_OUT_OF_DATE.
- [ ] Add resize handling: recreate swapchain and dependent resources on framebuffer resize; re-record command buffers.
